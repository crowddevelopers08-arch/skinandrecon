...
export const metadata: Metadata = {
  title: "Privacy Policy - Skin & Recon Cosmetic Surgery Clinic",
  description:
    "Privacy Policy for Skin & Recon Cosmetic Surgery Clinic. Learn how we protect and handle your personal and medical information.",
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-[#7b5f43]/10 to-transparent rounded-2xl p-8 mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              At Skin & Recon Cosmetic Surgery Clinic, we are committed to protecting your personal information and medical
              data. This privacy policy explains how we collect, use, and safeguard your information when you visit our
              website or use our cosmetic surgery services including liposuction, rhinoplasty, gynecomastia surgery, and blepharoplasty.
            </p>
          </div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-400">
                    ...
                    <li>Surgical preferences and consultation notes</li>
            ...
            <section className="bg-gray-900/50 rounded-2xl p-8 border border-[#7b5f43]/20">
              ...
              <div className="grid md:grid-cols-2 gap-6 text-gray-300">
                <div>
                  <h3 className="text-lg font-semibold text-white mb-3">Surgical Care</h3>
                  <ul className="list-disc list-inside space-y-1 text-gray-400">
                    <li>Providing cosmetic surgery consultations and treatments</li>
                    <li>Scheduling procedures like liposuction, rhinoplasty, etc.</li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-400">
                    ...
                    <li>Improving cosmetic surgery services</li>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-400">Dr. Rakesh Koudki & Dr. Shruthi Chikkaiah</p>
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Skin & Recon Cosmetic Surgery Clinic</p>
