...
export const metadata: Metadata = {
  title: "Thank You - Skin & Recon Clinic",
  description:
    "Thank you for booking your consultation with Skin & Recon Clinic. We will contact you soon.",
}
    ...
    <ThankNavbar />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Our team at Skin & Recon Clinic will review your request and contact you within 24 hours to
              schedule your consultation with our dual-specialist experts.
            </p>
          </div>
          ...
          <div className="bg-gray-900/50 rounded-2xl p-8 mb-12 border border-[#7b5f43]/20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">Our dual-specialist team reviews your consultation request</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#7b5f43]/20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">Meet with our specialists for personalized treatment planning</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#7b5f43]/10 to-transparent rounded-2xl p-8 mb-12">
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              ...
              <span>Skin & Recon Clinic, Bangalore, Karnataka, India</span>
            </div>
          </div>
      ...
      <footer className="border-t border-[#7b5f43]/20 bg-gray-900/50 py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-400">© 2025 Skin & Recon Clinic. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
