...
export const metadata: Metadata = {
  title: "Thank You - Skin & Recon Hair Transplant Clinic",
  description:
    "Thank you for booking your consultation with Skin & Recon Hair Transplant Clinic. We will contact you soon.",
}
...
export default function ThankYouPage() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Submit lead form Hair New conversion page */}
      <Script id="google-ads-conversion-hair-new" strategy="afterInteractive">
        {`
          gtag('event', 'conversion', {
            'send_to': 'AW-17776361413/K0aRCPuF--8bEMX_tpxC',
            'value': 1.0,
            'currency': 'INR'
          });
        `}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4">
              Your hair transplant consultation request has been successfully submitted.
            </p>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Our team at Skin & Recon Hair Transplant Clinic will review your request and contact you within 24 hours to
          ...
          <div className="bg-gray-900/50 rounded-2xl p-8 mb-12 border border-[#7b5f43]/20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">Our dual-specialist team reviews your hair loss pattern and medical history</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#7b5f43]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-400 text-sm">We'll call you within 24 hours to discuss FUE/DHI options and schedule</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#7b5f43]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-400 text-sm">Meet with Dr. Shruthi & Dr. Rakesh for your personalized hair restoration plan</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#7b5f43]/10 to-transparent rounded-2xl p-8 mb-12">
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              ...
              <span>Skin & Recon Hair Transplant Clinic, Bangalore, Karnataka, India</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/privacypolicy-hairtreatment">
              <Button
                variant="outline"
      ...
      <footer className="border-t border-[#7b5f43]/20 bg-gray-900/50 py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-400">© 2026 Skin & Recon Hair Transplant Clinic. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
