...
export const metadata: Metadata = {
  title: "Privacy Policy - Skin & Recon Clinic",
  description:
    "Privacy Policy for Skin & Recon Clinic. Learn how we protect and handle your personal information.",
}
...
export default function PrivacyPolicyPage() {
  return (
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Main Content */}
      <main className="container mx-auto px-4 max-[470px]:py-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-[#7b5f43]/10 to-transparent rounded-2xl p-8 mb-12">
            ...
            <p className="text-gray-300 leading-relaxed">
              At Skin & Recon Clinic, we are committed to protecting your personal information and medical
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-400">Dr. Rakesh Koudki</p>
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Skin & Recon Clinic</p>
