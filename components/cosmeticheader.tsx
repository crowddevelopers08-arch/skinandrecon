                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative hidden md:inline-flex group">
                            ...
                            <a href="#cosmeticform" className="relative inline-flex items-center justify-center px-6 py-2 text-base font-normal text-white bg-[#7b5f43] border border-transparent rounded-full" role="button"> 
                                Book Consultation
                            </a>
                        </div>
