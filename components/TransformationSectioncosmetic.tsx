...
export const TransformationSectioncosmetic: React.FC = () => {
  const benefits = [
    { 
      title: "Dual-Specialist Expertise", 
      description: "Dermatologist + Plastic Surgeon ensure beauty, symmetry & skin health.",
      icon: "lucide:users" 
    },
    { 
      title: "Precise, Natural-Looking Results", 
      description: "Every result is tailored to your facial & body proportions.",
      icon: "lucide:sparkles" 
    },
    { 
      title: "Minimally Invasive Techniques", 
      description: "Faster recovery, minimal scarring, advanced anaesthesia protocols.",
      icon: "lucide:scissors" 
    },
    { 
      title: "Dedicated Cosmetic Surgery Theatre", 
      description: "Sterile, private, fully equipped for all procedures.",
    ...
    { 
      ...
      description: "Follow-up support ensures long-lasting and complication-free healing.",
