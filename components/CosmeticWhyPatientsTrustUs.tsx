const CosmeticWhyPatientsTrustUs = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-serif font-light text-[#7b5f43] mb-4">
            Your Safety & Results Come First
          </h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            <h3 className="text-2xl md:text-3xl font-serif text-[#7b5f43] mb-8 leading-tight">
              Why Patients Trust Us for Cosmetic Surgery
            </h3>
            
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-[#7b5f43] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                </div>
                <p className="text-lg leading-relaxed">
                  <strong>Advanced Surgical Technology:</strong> State-of-the-art equipment for precision and safety
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Board-Certified Experts:</strong> Dual-specialist dermatology and plastic surgery team
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Strict Safety & Sterilization Protocols:</strong> Hospital-grade infection control measures
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Natural-Looking Transformations:</strong> Results that enhance your natural beauty
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>4.9★ Google Rating:</strong> Consistently excellent patient satisfaction
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Transparent Pricing & Honest Guidance:</strong> No hidden costs, clear treatment plans
                </p>
              </div>
            </div>
          </div>
...
export default CosmeticWhyPatientsTrustUs;